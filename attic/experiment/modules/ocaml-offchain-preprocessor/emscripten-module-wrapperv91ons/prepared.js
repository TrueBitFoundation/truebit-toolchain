var source_dir = "/Users/orie/Desktop/truebit-toolchain/experiment/modules/ocaml-offchain-preprocessor/emscripten-module-wrapperv91ons"
...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'reverse_alphabet.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'reverse_alphabet.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'reverse_alphabet.temp.asm.js';
...
// {{PRE_LIBRARY}}
  ...
  var NODEFS={isWindows:false,staticInit:function () {
        ...
        if (flags in NODEFS.flagsToPermissionStringMap) {
          ...
          // FIXME this is terrible.
          var nbuffer = new Buffer(orig_HEAP8.subarray(offset, offset + length));
          var res;
          try {
...
var real___memmove = asm["_memmove"]; asm["_memmove"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real___memmove.apply(null, arguments);
};
...
var __memset = Module["__memset"] = function() { return Module["asm"]["_memset"].apply(null, arguments) };
var ___letf2 = Module["___letf2"] = function() { return Module["asm"]["__letf2"].apply(null, arguments) };
var __memcpy = Module["__memcpy"] = function() { return Module["asm"]["_memcpy"].apply(null, arguments) };
...
var __memmove = Module["__memmove"] = function() { return Module["asm"]["_memmove"].apply(null, arguments) };
